...
void GPUDrivenRenderer::Consume(GraphicsDevice& device, const std::vector<SuperMeshInstance>& insts, const std::vector<SuperMeshInstance>& occInsts)
{
...
void GPUDrivenRenderer::OnFrameBegin(GraphicsDevice& device)
{
...
void GPUDrivenRenderer::ReinitHiZTexture(GraphicsDevice& device, const Texture2D& depth)
{
    if (m_HiZCullingSRV)
...
void GPUDrivenRenderer::GenerateHiZ(GraphicsDevice& device, const Texture2D& depth)
{
    if (!m_HiZ.IsValid())
    {
...
void GPUDrivenRenderer::InitMipsShaderResources(GraphicsDevice& device)
{
...
void GPUDrivenRenderer::Cull(GraphicsDevice& device, Camera& camera)
{
